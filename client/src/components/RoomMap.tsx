      ...
      >
         ...
         >
            ...
            <Stack direction="row" spacing={0.5} flexWrap="wrap">
               {zLevels.map((level) => {
                  const hasPlayer =
                     gameState?.current_room.coordinates.z === level;
                  const levelLabel =
                     level === 0
                        ? 'Ground'
                        : level === 1
                  ...
                  return (
                     <Chip
                        ...
                        variant={
                           selectedLayer === level ? 'filled' : 'outlined'
                        }
                        icon={
                           hasPlayer ? (
                              <Box
                     ...
                     return Object.entries(room.connections).map(
                        ([direction, connectedRoomId]) => {
                           if (direction === 'up' || direction === 'down')
                              return null;
                           if (!roomsOnLayer.includes(connectedRoomId))
                              return null;
                           ...
                           const startX =
                              start.x + Math.cos(angle) * roomOffset;
                           const startY =
                              start.y + Math.sin(angle) * roomOffset;
                           ...
                           return (
                              ...
                              >
                                 ...
                                 <Line
                                    ...
                                    stroke={
                                       isExit ? '#26a0a4' : DungeonColors.wall
                                    }
                                 ...
                                 <Rect
                                    ...
                                    fill={
                                       isExit ? '#26a0a4' : DungeonColors.door
                                    }
                                    stroke={
                                       isExit ? '#4dd0d4' : DungeonColors.wall
                                    }
                                    strokeWidth={2}
                                    cornerRadius={2}
                                 />
                        ...
                        >
                           ...
                           {(isCurrentRoom || isExit) && (
                              <Rect
                                 ...
                                 shadowOpacity={
                                    isCurrentRoom ? torchFlicker : 0.7
                                 }
                                 listening={false}
                              />
                           )}
                           ...
                           {npcs.length > 0 && (
                              <Group listening={false}>
                                 {npcs.slice(0, 3).map((npc, idx) => {
                                    ...
                                    const tokenColor = npc.friendly
                                       ? '#4CAF50'
                                       : '#F44336';
                                    const borderColor = npc.friendly
                                       ? '#81C784'
                                       : '#EF9A9A';
                                    return (
               ...
               <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                  <Box
                     sx={{
                        ...
                        height: 16,
                        background:
                           'linear-gradient(180deg, #C9A962 0%, #8B7355 100%)',
               ...
               <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                  <Box
                     sx={{
                        ...
                        height: 16,
                        background:
                           'linear-gradient(180deg, #1a6b6e 0%, #0f4547 100%)',
                        border: '2px solid #4dd0d4',
                        borderRadius: '3px',
                     }}
                  />
                  <Typography
               ...
               <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                  <Box
                     sx={{
                        ...
                        height: 16,
                        background:
                           'linear-gradient(180deg, #6B4E9D 0%, #4a3570 100%)',
