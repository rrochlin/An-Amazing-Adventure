...
function PostComponent() {
  ...
  const [gameStarted, setGameStarted] = useState(Route.useLoaderData().ready);
  ...
  const fetchGame = async () => {
    ...
    try {
      ...
      console.log(gameResponse.game_state);
  ...
  if (!gameStarted) {
    return (
      <Box sx={{ p: 4, textAlign: "center" }}>
        ...
        <Button variant="contained" onClick={fetchGame} disabled={isLoading}>
