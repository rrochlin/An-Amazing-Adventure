      ...
      >
         ...
         >
            ...
            <Alert severity="error" sx={{ mb: 3, textAlign: 'left' }}>
               The server encountered an error. Your adventures are safe —
               please try again.
            </Alert>
         ...
         >
            ...
            {quota.ai_enabled && quota.token_limit > 0 && (
               <Box sx={{ mb: 2 }}>
                  ...
                  <LinearProgress
                     ...
                     value={Math.min(
                        100,
                        (quota.tokens_used / quota.token_limit) * 100,
                     )}
                     color={
            ...
            {!quota.ai_enabled && (
               <Alert severity="info" sx={{ mb: 2 }}>
                  <strong>Preview Mode</strong> — AI narration is not yet
                  enabled for your account. Contact the admin to request access.
               </Alert>
            )}
                        ...
                        <Box sx={{ display: 'flex', gap: 0.5, flexShrink: 0 }}>
                           ...
                           <Tooltip title="Delete adventure" placement="left">
                              <IconButton
                                 size="small"
                                 onClick={(e) =>
                                    handleDelete(e, game.session_id)
                                 }
