      ...
      MuiPaper: {
         styleOverrides: {
            root: {
               ...
               boxShadow:
                  '0 4px 20px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(201, 169, 98, 0.1)',
            },
         },
      },
      MuiButton: {
         styleOverrides: {
            ...
            contained: {
               '&:hover': {
                  boxShadow:
                     '0 4px 12px rgba(201, 169, 98, 0.6), inset 0 1px 0 rgba(255, 215, 0, 0.5)',
               },
            },
         },
      },
...
export const getColorByMode = (
   mode: 'light' | 'dark',
   category: keyof typeof ColorTokens.dark,
) => {
