...
import { Button, Typography, Box, Paper, CircularProgress, Alert, Grid } from '@mui/material';
  ...
  const startGame = async () => {
    ...
    try {
      ...
      if (narrativeResponse.data && narrativeResponse.data.Response) {
        handleSetChatHistory({ type: 'narrative', content: narrativeResponse.data.Response });
      }
  ...
  const handleCommand = async () => {
    ...
    try {
      ...
      if (response.data && response.data.Response) {
        handleSetChatHistory({ type: 'narrative', content: response.data.Response });
      } else {
